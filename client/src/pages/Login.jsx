...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl shadow-slate-200/60 border border-slate-100">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl font-bold tracking-tight text-slate-900">
            Welcome back to Study<span className="text-indigo-600">Zen</span>
          </h2>
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-slate-300 px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
            />
          </div>
